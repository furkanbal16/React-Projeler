  ...
  return (
    <>
      ...
      <div className="font-bold text-black sm:space-y-3 text-lg flex flex-row justify-between sm:flex-col dark:text-custom-white">
        <div
          className={`cursor-pointer sm:hover:pl-2 hover:text-blue-900  duration-200 ${filterMode == "All" && "text-custom-blue dark:text-blue-500"
            }`}
        ...
        <div
          className={`cursor-pointer sm:hover:pl-2 hover:text-blue-900 duration-200 ${filterMode == "Active" && "text-custom-blue dark:text-blue-500"
            }`}
