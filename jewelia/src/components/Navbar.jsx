...
const Input = styled.input`
  ...
  &:focus {
  outline: none; /* Input elementine tıkladığımda oluşan border'ı kaldırdım */
}
`;
...
const Navbar = () => {
  return (
    <Container>
      <Wrapper>
        <Left>
          <Language style={{ color: "#86012d" }}>TR</Language>
          <SearchContainer>
            <Input placeholder="Ürün Ara" />
            <IoSearch style={{ color: "#da0049", fontSize: 16 }} />
          </SearchContainer>
        </Left>
        <Center>
